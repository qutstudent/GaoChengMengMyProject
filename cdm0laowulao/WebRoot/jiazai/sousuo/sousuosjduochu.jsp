...
<%
	...
	String sjduochuSjleixingId = (String) request.getParameter("sjleixingId");
	...
	if (StringUtil.isNotEmpty(sjduochuSjleixingId)) {
		sousuoSjduochuparam.append("&sjleixingId=" + sjduochuSjleixingId);
	}
