...
<style>
body{background: #fff url(<%=basePath%>shouye/login/images/shouye.jpg) 50% 0 no-repeat;margin:0;padding:0;}
#login{width:420px;height:420px;position:absolute;left:50%;top:35%;font-size:12px;line-height:24px;margin:-222px auto auto -210px;background:#fbfbfb;}
#login .logo{height:38px; text-align:center; font-size:30px; font-weight:bold; color:#4c91d1; margin-top:40px;}
#login .main{height:600px;background:#fff;overflow:hidden; border:#CCC 1px solid;box-shadow: 0 0 3px #ccc;}
...
<div id="login">
        ...
        <div class="main">
            ...
            <ul>
                ...
                <li>技&nbsp;&nbsp;&nbsp;&nbsp;能：<input class="wa" type="text" name="yonghuMark3" id="yonghuMark3"/></li>
                <li>地&nbsp;&nbsp;&nbsp;&nbsp;址：<input class="wa" type="text" name="yonghuMark4" id="yonghuMark4"/></li>
