...
var yonghuId=<%=yonghuId%>;
	...
	function xiajiaShuju(){
		...
		$.messager.confirm("系统提示","您确认要执行吗？",function(r){
			if(r){
				$.post(url,{yonghuId:yonghuId},function(result){
					if(result.errorMsg){
						$.messager.alert("系统提示",result.errorMsg);
						$("#dg").datagrid("reload");
					}else{
...
<!--startprint-->
	 ...
	 pagination="true" url="../getShujus" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="shujuDouble" width="10">工资</th>
				<th field="shujuZong" width="10">人数</th>
				<th field="shujuMark1" width="40">地点</th>
				<th field="shujuMark2" width="40">备注</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:xiajiaShuju()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">投递简历</a>
		</div>
		<div>
	...
	<div id="dlg" class="easyui-dialog" style="width: 850px;height: 420px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td valign="top"><%=newJcpeizhi.getShujuBieming()%>详情：</td>
