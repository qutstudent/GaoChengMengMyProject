...
var url;
	...
	function quxiaoYonghu(){
		...
		$.messager.confirm("系统提示","您确认要执行吗？",function(r){
			if(r){
				$.post(url,{yonghuType1:0},function(result){
					if(result.errorMsg){
						$.messager.alert("系统提示",result.errorMsg);
						$("#dg").datagrid("reload");
					}else{
...
<!--startprint-->
	 ...
	 pagination="true" url="../getYonghus?yonghuId=<%=yonghuId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="yonghuMark3" width="40">技能</th>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanYonghu()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传简历</a>
		</div>
	</div>
<!--endprint-->
