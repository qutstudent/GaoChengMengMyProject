...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjpinglunBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjpingluns?yonghuId=<%=yonghuId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjpinglunName" width="80">评论</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:openSjpinglunModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">修改</a>
			<a href="javascript:deleteSjpinglun()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">删除</a>
		</div>
		<div>
