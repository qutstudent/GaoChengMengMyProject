...
<div class="header bg-main">
  ...
  <div class="head-l">
  	...
  	&nbsp;&nbsp;<a class="button button-little bg-green" href="<%=basePath%>" target="_blank"><span class="icon-home"></span>前台网站</a>  
  </div>
</div>
<div class="leftnav">
  ...
  <ul>
    ...
    <li><a href="<%=basePath%>yonghu/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>" target="right"><span class="icon-caret-right"></span><%=jcdaohangslist.get(i).get(j).getJcdaohangName() %></a></li>
    <%} %>
  </ul>
  <%} %>
</div>
