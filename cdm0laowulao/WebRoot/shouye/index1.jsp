    ...
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <div class="panel loginbox">
                ...
                <input type="submit" value="登 录" class="button bg-main text-big input-big" style="width:100%"  onclick = "return validate()"/></div>
                <div style="padding:30px;">
                <a href="<%=basePath%>user/zhuceuser.jsp"><input type="button" class="button bg-main text-big input-big" value="<%=newJcpeizhi.getUserBieming()%>注册" style="width:48%"></a>&nbsp;
                <a href="<%=basePath%>yonghu/zhuceyonghu.jsp"><input type="button" class="button bg-main text-big input-big" value="<%=newJcpeizhi.getYonghuBieming()%>注册" style="width:48%"></a></div>
