...
<div class="login" style="margin-top:50px;">
  <div class="web_qr_login" id="web_qr_login" style="display: block; height: 340px;">    
			...
			<div class="login_form">
               ...
               <div class="inputOuter" id="pArea">
                ...
                <input type="submit" value="登 录" style="width:200px;" class="button_blue"/>
                </div>
                <div style="padding-left:50px;margin-top:20px;">
                <a href="<%=basePath%>user/zhuceuser.jsp"><input type="button" value="<%=newJcpeizhi.getUserBieming()%>注册" style="width:100px;" class="button_blue"/></a>&nbsp;<a href="<%=basePath%>yonghu/zhuceyonghu.jsp"><input type="button" value="<%=newJcpeizhi.getYonghuBieming()%>注册" style="width:100px;" class="button_blue"/></a>
                </div>
              </form>
           </div>
           </div>
