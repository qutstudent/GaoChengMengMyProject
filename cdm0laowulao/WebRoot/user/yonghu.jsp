...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getYonghuBieming()%>信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYonghus?yonghuType1=1" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="yonghuId" width="10" hidden="true">编号</th>
				<th field="yonghuName" width="20" hidden="true">登录名</th>
				...
				<th field="yonghuMark1" width="20">学校</th>
				<th field="yonghuMark2" width="20">专业</th>
				<th field="yonghuMark3" width="20">技能</th>
				<th field="yonghuMark4" width="40">地址</th>
				<th field="yonghuImgName" width="20" formatter="formatXiazai">简历</th>
