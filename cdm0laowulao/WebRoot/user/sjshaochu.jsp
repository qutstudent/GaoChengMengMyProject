...
var userId = <%=userId%>;
	function searchSjshaochu(){
		$('#dg').datagrid('load',{
			sjshaochuName:$('#s_sjshaochuName').val(),
...
<!--startprint-->
	 ...
	 pagination="true" url="../getSjshaochus?userId=<%=userId %>" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjshaochuName" width="20">技能</th>
				<th field="sjshaochuImgName" width="10" formatter="formatXiazai">简历</th>
	...
	<div id="tb">
		<div>
			<a href="javascript:luyongSjshaochu()" class="easyui-linkbutton" iconCls="icon-add" plain="true">录用</a>
			<a href="javascript:bohuiSjshaochu()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">驳回</a>
		</div>
		<div>
		&nbsp;技能：&nbsp;<input type="text" name="s_sjshaochuName" id="s_sjshaochuName" size="10"/>
